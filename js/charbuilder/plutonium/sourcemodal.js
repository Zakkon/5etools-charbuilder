...
class AppSourceSelectorMulti extends ModalFilter {
    ...
    _$getStageUpload() {
        const $btnAddUpload = $(`<button class="btn btn-5et ve-btn-default btn-xs">Add File</button>`).click(()=>{
            const nxt = {
                id: CryptUtil.uid(),
                data: {
                    name: null,
    ...
    _$getStageUrl() {
        const $btnAddUrl = $(`<button class="btn btn-5et ve-btn-default btn-xs">Add Custom</button>`).click(()=>{
